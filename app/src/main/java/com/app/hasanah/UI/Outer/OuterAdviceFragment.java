...
import com.app.hasanah.databinding.FragmentOuterAdviceBinding;
...
public class OuterAdviceFragment extends Fragment {
    private FragmentOuterAdviceBinding mBinding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBinding = FragmentOuterAdviceBinding.inflate(inflater, container, false);

        mBinding.arrowBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navigationTo(R.id.action_outerAdvice_to_outerResult);
            }
        });
